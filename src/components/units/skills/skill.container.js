      ...
      <S.SkillWrapper>
        ...
        <S.SkillContentsContainer zoom={props.zoom}>
          <S.SkillContentsWrapper>
            ...
            <S.SkillChartDiv>
              <S.SkillChartPer zoom={props.zoom} per={"100%"}></S.SkillChartPer>
            </S.SkillChartDiv>
          </S.SkillContentsWrapper>
          <S.SkillContentsWrapper>
            ...
            <S.SkillChartDiv>
              <S.SkillChartPer zoom={props.zoom} per={"80%"}></S.SkillChartPer>
            </S.SkillChartDiv>
          </S.SkillContentsWrapper>
      ...
      <S.SkillWrapper>
        ...
        <S.SkillContentsContainer zoom={props.zoom}>
          ...
          <S.SkillContentsWrapper>
            ...
            <S.SkillChartDiv>
              <S.SkillChartPer zoom={props.zoom} per={"60%"}></S.SkillChartPer>
            </S.SkillChartDiv>
          </S.SkillContentsWrapper>
          <S.SkillContentsWrapper>
